    ...
    const mapImage = document.querySelector('.building-map');
        ...
        mapImage.addEventListener('load', () => {
            ...
            const rooms = [
                ...
                { id: 'room1m1', coords: '754,597,50', shape: 'circle', group:'mic',status: 'occupied' },
                { id: 'room1m2', coords: '1003,737,50', shape: 'circle', group:'mic',status: 'occupied' },
                { id: 'room4m3', coords: '998,597,50', shape: 'circle', group:'mic',status: 'occupied' },
                { id: 'room4m4', coords: '749,736,50', shape: 'circle', group:'mic',status: 'occupied' },
