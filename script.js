    ...
    const mapImage = document.querySelector('.building-map');
        ...
        mapImage.addEventListener('load', () => {
            ...
            const rooms = [
                ...
                { id: 'room1m1', coords: '754,560,7', shape: 'circle', group:'mic',status: 'occupied' },
                { id: 'room1m2', coords: '1003,737,7', shape: 'circle', group:'mic',status: 'occupied' },
                { id: 'room4m3', coords: '998,597,7', shape: 'circle', group:'mic',status: 'occupied' },
                { id: 'room4m4', coords: '749,736,7', shape: 'circle', group:'mic',status: 'occupied' },
                { id: 'room3m1', coords: '461,594,7', shape: 'circle',  group:'mic',status: 'occupied' },
                { id: 'room3m2', coords: '560,591,7', shape: 'circle',  group:'mic',status: 'occupied' },
                { id: 'room3m3', coords: '625,642,7', shape: 'circle',  group:'mic',status: 'occupied' },
                { id: 'room3m4', coords: '625,708,7', shape: 'circle',  group:'mic',status: 'occupied' },
                { id: 'room3m5', coords: '557,740,7', shape: 'circle',  group:'mic',status: 'occupied' },
                { id: 'room3m6', coords: '467,739,7', shape: 'circle',  group:'mic',status: 'occupied' },
            ];
