    ...
    const mapImage = document.querySelector('.building-map');
        ...
        mapImage.addEventListener('load', () => {
            ...
            const rooms = [
                ...
                { id: 'room1m1', coords: '754,597,15', shape: 'circle', group:'mic',status: 'occupied' },
                { id: 'room1m2', coords: '1003,737,15', shape: 'circle', group:'mic',status: 'occupied' },
                { id: 'room4m3', coords: '998,597,15', shape: 'circle', group:'mic',status: 'occupied' },
                { id: 'room4m4', coords: '749,736,15', shape: 'circle', group:'mic',status: 'occupied' },
                { id: 'room3m1', coords: '461,594,15', shape: 'circle',  group:'mic',status: 'occupied' },
                { id: 'room3m2', coords: '560,591,15', shape: 'circle',  group:'mic',status: 'occupied' },
                { id: 'room3m3', coords: '625,642,15', shape: 'circle',  group:'mic',status: 'occupied' },
                { id: 'room3m4', coords: '625,708,15', shape: 'circle',  group:'mic',status: 'occupied' },
                { id: 'room3m5', coords: '557,740,15', shape: 'circle',  group:'mic',status: 'occupied' },
                { id: 'room3m6', coords: '467,739,15', shape: 'circle',  group:'mic',status: 'occupied' },
            ];
