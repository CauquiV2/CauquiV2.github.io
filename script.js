...
document.addEventListener('DOMContentLoaded', function() {
    ...
    mapImage.addEventListener('load', () => {
        ...
        const rooms = [
            ...
            { id: 'room1m1', coords: '754,604,14', shape: 'circle', group:'mic',status: 'occupied' },
            { id: 'room1m2', coords: '1003,737,14', shape: 'circle', group:'mic',status: 'occupied' },
            { id: 'room4m3', coords: '998,597,14', shape: 'circle', group:'mic',status: 'occupied' },
            { id: 'room4m4', coords: '749,736,17', shape: 'circle', group:'mic',status: 'occupied' },
            { id: 'room3m1', coords: '461,594,10', shape: 'circle',  group:'mic',status: 'occupied' },
            { id: 'room3m2', coords: '560,591,13', shape: 'circle',  group:'mic',status: 'occupied' },
            { id: 'room3m3', coords: '625,642,12', shape: 'circle',  group:'mic',status: 'occupied' },
            { id: 'room3m4', coords: '625,708,12', shape: 'circle',  group:'mic',status: 'occupied' },
            { id: 'room3m5', coords: '557,740,10', shape: 'circle',  group:'mic',status: 'occupied' },
            { id: 'room3m6', coords: '467,739,10', shape: 'circle',  group:'mic',status: 'occupied' },
        ];
        ...
        rooms.forEach(room => {
            ...
            areaDiv.classList.add(room.shape);
            areaDiv.id = room.id;
